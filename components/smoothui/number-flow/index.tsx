...
export default function NumberFlow({
  ...
  return (
    <div
      className={cn(
        "flex min-h-screen flex-col items-center justify-center gap-8 pt-4",
        className
      )}
    >
      <div className="flex items-center gap-2 rounded-xl border-muted-foreground/65 border-2 bg-background p-4">
