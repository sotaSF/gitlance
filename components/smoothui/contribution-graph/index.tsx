...
const CONTRIBUTION_COLORS = [
  "dark:bg-gray-800/50 bg-gray-200/80", // Level 0 - No contributions
  "bg-brand/30", // Level 1
  "bg-brand/60", // Level 2
  "bg-brand/80", // Level 3
...
export function ContributionGraph({
  ...
  return (
    <div className={`contribution-graph ${className}`}>
      ...
      {/* Tooltip */}
      {showTooltips && hoveredDay && isMounted && createPortal(
        <motion.div
          animate={{ opacity: 1, scale: 1 }}
          className="pointer-events-none fixed z-[9999] rounded-lg border border-white/20 bg-black/90 backdrop-blur-sm px-3 py-2 text-white text-sm shadow-2xl"
